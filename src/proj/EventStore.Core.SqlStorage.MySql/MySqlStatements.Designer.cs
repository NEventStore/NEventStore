...
namespace EventStore.Core.SqlStorage.MySql {
    ...
    internal class MySqlStatements {
        ...
        ///SELECT @id, @initial_version{0}, UTC_TIMESTAMP(), @command_id, @payload{0};.
        /// </summary>
        ...
        ///   Looks up a localized string similar to INSERT
        ///  INTO Aggregates
        ///     ( Id, Version, Snapshot, Created, RuntimeType )
        ///SELECT @id,
        ///       @current_version,
        ...
        ///       Snapshot = CASE WHEN @payload IS NULL THEN Snap [rest of string was truncated]&quot;;.
        /// </summary>
