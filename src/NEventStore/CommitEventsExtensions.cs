...
public static class CommitEventsExtensions
{
    ...
    public static IEnumerable<ICommit> GetFrom(this ICommitEvents commitEvents, string streamId, int minRevision,
        int maxRevision)
    {
        if (commitEvents == null) throw new ArgumentNullException(nameof(commitEvents));
