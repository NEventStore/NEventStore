namespace NEventStore.Persistence
{
    ...
    public static class PersistStreamsExtensions
    {
        ...
        [Obsolete(
            "Will be removed in a future revision because of inconsistency with GetFrom(checkpointToken) which returns commits from all the buckets")]
        ...
        /// <exception cref="StorageUnavailableException" />
        [Obsolete(
            "Will be removed in a future revision because of inconsistency with GetFrom(checkpointToken, from, to) which returns commits from all the buckets")]
        ...
        public static ICommit GetCommit(this IPersistStreams persistStreams, long checkpointToken)
        {
