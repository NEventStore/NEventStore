...
namespace NEventStore
{
    ...
    public interface IStoreEvents : IDisposable
    {
        ...
        /// <exception cref="StorageUnavailableException" />
        /// <exception cref="StreamNotFoundException" />
        Task<IEventStream> OpenStreamAsync(string bucketId, string streamId, int minRevision, int maxRevision, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="StorageException" />
        /// <exception cref="StorageUnavailableException" />
        Task<IEventStream> OpenStreamAsync(ISnapshot snapshot, int maxRevision, CancellationToken cancellationToken = default);
    }
}